...
class AnalysisShapeTests(unittest.TestCase):
    ...
    def test_dashboard_render_contains_key_sections(self) -> None:
        ...
        self.assertIn("state-board", dashboard)
        self.assertIn("Trade locked", dashboard)
        self.assertIn("top-nav", dashboard)
        self.assertIn("layout-dashboard", dashboard)
        self.assertIn("layout-market", dashboard)
        self.assertIn("layout-decision", dashboard)
        self.assertIn("layout-technical", dashboard)
        self.assertIn("layout-macro", dashboard)
        self.assertIn("layout-geopolitics", dashboard)
